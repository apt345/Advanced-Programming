...
//no hacer caso a los "errores rojos" de Rstudio
  
  
  
  
  
//parte b, 3 vecinos. Seleccionar el vecino más próximo, luego el segundo, luego el tercero
//hacerlo en el paquete directamente, no en sourcecpp